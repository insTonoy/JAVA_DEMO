...
public class ApprovalFrame extends JFrame {
    ...
    public ApprovalFrame() {
        ...
        tableModel = new DefaultTableModel(new String[] { "BorrowID", "Username", "Book Title", "Approval Status" },
                0);
    ...
    private void handleApproval(boolean isApproved) {
        ...
        String newStatus = isApproved ? "accepted" : "declined";
        
        BorrowFileHandler.updateApprovalStatus(borrowId, newStatus);
        
        if (isApproved) {
            PatronFileHandler.updateBorrowCount(username, 1);
        }
