...
public class BorrowFileHandler {
    ...
    public static void updateApprovalStatus(String borrowId, String newStatus) {
        System.out.println("Updating status for Borrow ID: " + borrowId + " to " + newStatus);
    ...
    public static Borrow[] getAllPendingRequests() {
        System.out.println("Fetching all pending requests...");
